...
namespace Sidorova.Lab3.Exercise1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            while (true)
            {
                Console.WriteLine("Если хотите начать/продолжить работу программы - нажмите 1");
                Console.WriteLine();
                Console.WriteLine("Если хотите прекратить работу программы - нажмите 2");
                Console.WriteLine();
                int i;
